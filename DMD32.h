...
#define PIN_DMD_nOE		16 		// D22 active low Output Enable, setting this low lights all the LEDs in the selected rows. Can pwm it at very high frequency for brightness control.
#define PIN_DMD_A		25		// D19
...
class DMD
{
  ...
  private:
    ...
    //uninitalised pointer to SPI object
	  SPIClass * vspi = NULL;
	  static const int spiClk = 500000; // 4 MHz SPI clock
