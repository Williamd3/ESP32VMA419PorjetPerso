...
void DMD::scanDisplayBySPI()
{
    ...
    if( (digitalRead( PIN_OTHER_SPI_nCS ) == HIGH) && (bDMDScreenRAM != NULL) )
    {
      //Serial.println("write");
        ...
        for (int i=0;i<rowsize;i+=4) {
         vspi->transfer(~bDMDScreenRAM[offset+i+0+row3]);
         vspi->transfer(~bDMDScreenRAM[offset+i+0+row2]);
         vspi->transfer(~bDMDScreenRAM[offset+i+1+row3]);
         vspi->transfer(~bDMDScreenRAM[offset+i+1+row2]);
         vspi->transfer(~bDMDScreenRAM[offset+i+0+row1]);
         vspi->transfer(~bDMDScreenRAM[offset+i+0]);
         vspi->transfer(~bDMDScreenRAM[offset+i+1+row1]);
         vspi->transfer(~bDMDScreenRAM[offset+i+1]);
         vspi->transfer(~bDMDScreenRAM[offset+i+2+row3]);
         vspi->transfer(~bDMDScreenRAM[offset+i+2+row2]);
         vspi->transfer(~bDMDScreenRAM[offset+i+3+row3]);
         vspi->transfer(~bDMDScreenRAM[offset+i+3+row2]);
         vspi->transfer(~bDMDScreenRAM[offset+i+2+row1]);
         vspi->transfer(~bDMDScreenRAM[offset+i+2]);
         vspi->transfer(~bDMDScreenRAM[offset+i+3+row1]);
         vspi->transfer(~bDMDScreenRAM[offset+i+3]);
         }
